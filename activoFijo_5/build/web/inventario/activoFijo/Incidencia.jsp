...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    ...
    <body>
        ...
        <script>
            var estatus= [{"value": "OTRO","text": "OTRO"},{"value": "DETERIORO","text": "DETERIORO"},{"value": "FALLA","text": "FALLA"}];
                     ...
                     schema: {
                        ...
                        model: {
                            ...
                            fields: {
                                ...
                                tipoIncidencia: { type:     "string", defaultValue:'DETERIORO', values: estatus},
                ...
                $("#grid").kendoGrid({
                    ...
                    pageable: {
                        ...
                        columns: [
                            ...
                            { field: "tipoIncidencia", title:"Incidencia encontrada",encoded: false, defaultValue:'DETERIORO', values: estatus,width:"200px"},
                            { field: "descripcion", title: "Descripcion",encoded: false,width:"250px"},
                                ...
                                dataSource: {
                                    ...
                                    listaDropDownDepartamento=$('input[name="idDepartamento"]').kendoDropDownList({
                                        ...
                                        dataSource: {
                                            ...
                                            listaDropDownActivo.dataSource.options.transport.read.url="../../beaconsAgencias/Activos.do?modo=combo&idDepartamento="+listaDropDownDepartamento.value();
                                            ...
                                            listaDropDownActivo=$('input[name="idActivo"]').kendoDropDownList({
                                                ...
                                                dataSource: {
                                                    transport: {
                                                        read: {
                                                            dataType: "json",
                                                            url: "../../beaconsAgencias/Activos.do?modo=combo&idDepartamento="+listaDropDownDepartamento.value()
                                                        }
                                                    }
                                                }
