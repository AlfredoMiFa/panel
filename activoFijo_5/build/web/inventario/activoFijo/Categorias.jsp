        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">            
                ...
                <jsp:include page="/menu.do">
                    ...
                    <jsp:param name="M_SELECT" value="C-G-CATE"/>
                </jsp:include>
            </nav>
            <div id="page-wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <i class="fa fa-unlock-alt"></i> Categorias de activos
                                </li>
                            </ol>
                        </div>
                    </div> 
        ...
        <script>
            $(document).ready(function(){
                ...
                var dataSource = new kendo.data.DataSource({
                   transport: {
                     read:   {
                        url: "../../beaconsAgencias/categorias.do",
                        dataType: "json"
                     },
                     update: {
                        url: "../../beaconsAgencias/categorias.do?modo=editar",
                        type: "POST",
                        dataType: "json",
                        complete: function(e) {
                     ...
                     destroy: {
                         url: "../../beaconsAgencias/categorias.do?modo=eliminar",
                         type: "POST",
                         dataType: "json",
                         complete: function(e) {
                            if (typeof (e.responseText) !== "undefined")
                      ...
                      create: {
                          url: "../../beaconsAgencias/categorias.do?modo=nuevo",
                          type: "POST",
                          dataType: "json",
                          complete: function(e) {
                     ...
                     schema: {
                        ...
                        model: {
                            id: "idCategoria",
                            fields: {
                                idCategoria:      { type: "number", editable: false, nullable: false },
                                descripcion:      { type: "string", editable: true, nullable: true,validation:{  required: true,maxlength:45 }}
                            }
                        },
                        error: "errors"
                    },
                ...
                $("#grid").kendoGrid({
                    ...
                    pageable: {
                        ...
                        columns: [    
                            { field: "idCategoria",title:"Clave categoria",encode: false,width:"100px"},
                            { field: "descripcion",        title:"Nombre categoria",encoded: false,width:"150px"}, 
