        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">            
                ...
                <jsp:include page="/menu.do">
                    ...
                    <jsp:param name="M_SELECT" value="C-G-DERSIS"/>
                </jsp:include>
            </nav>
            <div id="page-wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <i class="fa fa-unlock-alt"></i> Derechos del sistema
                                </li>
                            </ol>
                        </div>
                    </div> 
        ...
        <script>
            $(document).ready(function(){
                ...
                var dataSource = new kendo.data.DataSource({
                   transport: {
                     read:   {
                        url: "../generals/derechoSistema.do",
                        dataType: "json"
                     },
                     update: {
                        url: "../generals/derechoSistema.do?modo=editar",
                        type: "POST",
                        dataType: "json",
                        complete: function(e) {
                     ...
                     destroy: {
                         url: "../generals/derechoSistema.do?modo=eliminar",
                         type: "POST",
                         dataType: "json",
                         complete: function(e) {
                            if (typeof (e.responseText) !== "undefined")
                      ...
                      create: {
                          url: "../generals/derechoSistema.do?modo=nuevo",
                          type: "POST",
                          dataType: "json",
                          complete: function(e) {
                ...
                $("#grid").kendoGrid({
                    ...
                    columns: [
                        { field:"derecho", title: "Derecho", width: "200px"},
