                     ...
                     schema: {
                        ...
                        model: {
                            ...
                            fields: {
                                ...
                                email:        { type: "string", editable: true, nullable: true,validation:{  required: true,maxlength:30  }}
                            }
                        },
                        error: "errors"
                    },
                ...
                $("#grid").kendoGrid({
                    ...
                    pageable: {
                        ...
                        columns: [    
                            ...
                            { field: "contrasenia",        title:"Contrasena",encoded: false,width:"100px"}, 
                            { field: "nombre",        title:"Nombre",encoded: false,width:"100px"}, 
                            { field: "apellidoPaterno",        title:"Apellido Paterno",encoded: false,width:"100px"}, 
                            { field: "apellidoMaterno",        title:"Apellido Materno",encoded: false,width:"100px"}, 
                            { field: "email",        title:"Email",encoded: false,width:"100px"}, 
