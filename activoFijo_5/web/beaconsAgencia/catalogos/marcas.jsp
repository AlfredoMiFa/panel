        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">            
                ...
                <jsp:include page="/menu.do">
                    ...
                    <jsp:param name="M_SELECT" value="C-G-MARCAS"/>
                </jsp:include>
            </nav>
            <div id="page-wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <i class="fa fa-unlock-alt"></i> Marcas
                                </li>
                            </ol>
                        </div>
                    </div> 
        ...
        <script>
            $(document).ready(function(){
                ...
                var dataSource = new kendo.data.DataSource({
                   transport: {
                     read:   {
                        url: "../../beaconsAgencias/marcas.do",
                        dataType: "json"
                     },
                     update: {
                        url: "../../beaconsAgencias/marcas.do?modo=editar",
                        type: "POST",
                        dataType: "json",
                        complete: function(e) {
                     ...
                     destroy: {
                         url: "../../beaconsAgencias/marcas.do?modo=eliminar",
                         type: "POST",
                         dataType: "json",
                         complete: function(e) {
                            if (typeof (e.responseText) !== "undefined")
                      ...
                      create: {
                          url: "../../beaconsAgencias/marcas.do?modo=nuevo",
                          type: "POST",
                          dataType: "json",
                          complete: function(e) {
                     ...
                     schema: {
                        ...
                        model: {
                            id: "idMarca",
                            fields: {
                                idMarca:      { type: "number", editable: false, nullable: false },
