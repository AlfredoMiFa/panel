    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("email")!=null){                    
            try {
                ...
                response.getWriter().print(coreUsuarioEJB.recuperarContrasena(cadenaEncriptacion,request.getParameter("email"),"http://"+request.getLocalAddr()+":"+request.getLocalPort()+request.getContextPath()+"/"));
            }catch (IOException e) {
