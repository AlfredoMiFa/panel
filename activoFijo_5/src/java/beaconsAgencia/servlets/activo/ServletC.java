 ...
 */
@WebServlet(name = "ServletC", urlPatterns = {"/beaconsAgencias/Ciu.do"})
public class ServletC extends HttpServlet {

    @EJB
    CiudadFacadeLocal CiudadEJB;
    @EJB
    EstadoFacadeLocal EstadosEJB;
    /**
            ...
            try {
                if(request.getParameter("modo")==null) {
                    ...
                    if(modo.equals("eliminar")) {
                        ...
                        ciudad.setIdEstado(EstadosEJB.find(Integer.parseInt(request.getParameter("idEstado"))));
