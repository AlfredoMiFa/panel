 ...
 */
@WebServlet(name = "ServletCategoria", urlPatterns = {"/beaconsAgencias/categorias.do"})
public class ServletCategoria extends HttpServlet {

    @EJB
    CategoriasFacadeLocal CategoriasEJB;
    /**
        ...
        if(session.getAttribute(getServletContext().getInitParameter("vsi")+"SESION")==null){
            ...
            try {
                if(request.getParameter("modo")==null) {
                    ...
                    response.getWriter().print(CategoriasEJB.select(rows,page,sort,order,filter));
                 }else {
                    String modo=request.getParameter("modo");
                    String id=request.getParameter("idCategoria");
                    Categoria categoria = new Categoria();
                    if(modo.equals("eliminar")) {
                        CategoriasEJB.remove(CategoriasEJB.find(Integer.parseInt(id)));
                        ...
                        response.getWriter().print(CategoriasEJB.persistir(categoria,modo));
                    }else if(modo.equals("combo")){
                        response.getWriter().print(CategoriasEJB.combo("",""));
                    }
                } 
